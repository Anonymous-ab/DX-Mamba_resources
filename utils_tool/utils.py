...
def get_eval_score(references, hypotheses):
    ...
    ref =  [[' '.join(reft)] for reft in [[str(x) for x in reft] for reft in references]] # changed for the lung dataset
    # hypo =  [[str(hypo)] for hypo in hypotheses]
    # ref =  [[str(refe)] for refe in references]
    # print(hypo)
    # print(type(ref))
    # print(len(ref))
    # print(xx)
